...
A problem also lies in the translation itself. Although translation services are widely accessible, we can not sent a customer's data outside their environment so a local translation server must be used.
